...
class ChallangePI extends Component {
            ...
            all.forEach(element => {
                ...
                if ((this.state.aim) === (this.state.current)) {
                    ...
                    this.setState({
                        ...
                        if (localStorage.getItem("MaxChallangePIScore")) {
                            if (localStorage.getItem("MaxChallangePIScore") < this.state.score) {
                                localStorage.setItem("MaxChallangePIScore", this.state.score)
                            }
                        } else {
                            localStorage.setItem("MaxChallangePIScore", this.state.score)
                        }
    ...
    render() {
        return (
            <>
                <div className="info">&nbsp;&nbsp;Pi Challenge</div>
